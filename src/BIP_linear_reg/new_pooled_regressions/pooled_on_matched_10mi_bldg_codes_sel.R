...
#selected bldg codes
bldg_list <- c("A0G", "A0Z", "M40", "MC0", "MCT", "MD0", "MDF", "MS0", "MT0", "R00", 
               "R0C", "R10", "R20", "R30", "RQ0", "RS0", "RT0", "RU0", "YDA")

match_data <- match_data[match_data$bldg_code %in% bldg_list,]
...
saveRDS(model_res,file="BIP_linear_reg/lm_fe_matched_robust10_bldg_codes_sel.RDS")
