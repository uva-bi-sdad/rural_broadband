...
lmfe_ftth <- readRDS("BIP_linear_reg/fe_matched_quant1.RDS")
lmfe_wire <- readRDS("BIP_linear_reg/fe_matched_quant2.RDS")
lmfe_dsl <- readRDS("BIP_linear_reg/fe_matched_quant3.RDS")
...
ggplot(data=plotmodels_tech) + 
  ...
  labs(#title = "Estimated Coefficients on the Interactions between BIP and 2-year Period Dummies", 
    ...
    y = "Estimate, %")+
  theme_classic()
ggsave("BIP_linear_reg/ma_awardplot.png",height=4.5,width=6)
