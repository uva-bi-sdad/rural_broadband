# Define eligibility regions based on  criteria for Broadband Initiatives Program (loans, grants, and combinations):
# DIRECT QUOTE: 75 percent of the proposed funded area qualifies as rural area 
# without sufficient access to broadband service to facilitate rural economic development.
...
places <- readOGR(dsn="~/git/dspg19broadband/data/original/gz_2010_51_160_00_500k",layer="gz_2010_51_160_00_500k")
