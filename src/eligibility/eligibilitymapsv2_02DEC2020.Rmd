...
# 
# saveRDS(map_14_df_pop, "/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/USA_2014_final_eligibility_dfnogeopop_03DEC2020v3.RDS")

map_14_df_pop <- readRDS("/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/USA_2014_final_eligibility_dfnogeopop_03DEC2020v3.RDS")
...
# saveRDS(map_18_df_pop, "/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/USA_2018_final_eligibility_dfnogeopop_03DEC2020v3.RDS")

map_18_df_pop <- readRDS("/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/USA_2018_final_eligibility_dfnogeopop_03DEC2020v3.RDS")
...
summary_2014rc_bc <- data.frame("Year" = 2014, 
                           ...
                           "Program" = "ReConnect", 
                           "Measure" = "Block Ct", 
                           "ELIG_CT" = map_14_df %>% filter(eligibility_final == "eligible") %>% nrow()) %>%
...
summary_2018rc_bc <- data.frame("Year" = 2018, 
                           ...
                           "Program" = "ReConnect", 
                           "Measure" = "Block Ct", 
                           "ELIG_CT" = map_18_df %>% filter(eligibility_final == "eligible") %>% nrow()) %>%
  mutate("PERC_ELIG_NATL" = ELIG_CT/(nrow(map_18_df) - ELIG_CT))
...
summary_2014rc_pop <- data.frame("Year" = 2014, 
  ...
  mutate("PERC_ELIG_NATL" = ELIG_CT/(sum(map_14_df_pop$pop, na.rm = TRUE) - ELIG_CT))
...
summary_2018rc_pop <- data.frame("Year" = 2018, 
  ...
  mutate("PERC_ELIG_NATL" = ELIG_CT/(sum(map_18_df_pop$pop, na.rm = TRUE) - ELIG_CT))
```
...
summary_2014cc_bc <- data.frame("Year" = 2014, 
                           ...
                           "Measure" = "Block Ct", 
                           "ELIG_CT" = map_14_df %>% filter(disqual1 == "eligible" & disqual2 == "eligible") %>% nrow()) %>%
  mutate("PERC_ELIG_NATL" = ELIG_CT/(nrow(map_14_df) - ELIG_CT))
...
summary_2018cc_bc <- data.frame("Year" = 2018, 
                           ...
                           "Program" = "Comm Connect", 
                           "Measure" = "Block Ct", 
                           "ELIG_CT" = map_18_df %>% filter(disqual1 == "eligible" & disqual2 == "eligible") %>% nrow()) %>%
  mutate("PERC_ELIG_NATL" = ELIG_CT/(nrow(map_18_df) - ELIG_CT))
...
# 
# write.csv(states_summaries, "/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/working/eligibility_summary_percentages/states_summaries_02DEC2020.csv")
...
# write.csv(summary_states_, "/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/working/eligibility_summary_percentages/summary_states_02DEC2020.csv")
...
# 
# write.csv(summary_states_change, "/project/biocomplexity/sdad/projects_data/project_data/usda/rural_broadband/working/eligibility_summary_percentages/summary_states_change_02DEC2020.csv")
